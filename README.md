...
- Онбординг (3.3) в ТЗ описан как последовательность skip-able экранов; реализован как единая форма в профиле — функционально эквивалентно, но другой UX-поток.
- Индикатор непрочитанных сообщений в списке чатов (6.2) отсутствует.
